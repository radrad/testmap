...
var cluster = {
	...
	evaluation: {
		...
		initialize: function(){
			...
			cluster.initialize(1); // param is Clustering alg on start
		},
		pause: function(){
		...
		nextStep: function(param){
			...
			switch(cluster.evaluation.step){
				...
				/*
					...
					cluster.evaluation.findCityStep({
						html: "<h1>Evaluation: Clustering für heterogene Point-Clouds</h1>Gruppe: <strong>"+cluster.evaluation.group+"</strong><h2>Aufgabe 3</h2>Finden Sie erneut die 2 Hotels im Süden von Toledo, Spanien, die den folgenden Anforderungen entsprechen:<br><br>Preis: maximal 50€<br>Sterne: mindestens 2<br><br>Klicken Sie auf ein Hotel, damit die Werte angezeigt werden. Hier können Sie auf das Plus-Symbol klicken, um das Hotel auszuwählen.<br><br>Zeitvorgabe: Maximal 3 Minuten<br>Verbleibend: <span id='time'>3:00</span><br><br><strong>Fortschritt:</strong>",
				...
				/*
					...
					cluster.evaluation.findCityStep({
						html:"<h1>Evaluation: Clustering für heterogene Point-Clouds</h1>Gruppe: <strong>"+cluster.evaluation.group+"</strong><h2>Aufgabe 4</h2>Finden Sie erneut die 2 Hotels in Vientiane, Laos. Die Hotels müssen in der Nähe des Mekong Rivers liegen und folgende Kriterien erfüllen:<br><br>Preis: maximal 20€<br><br>Klicken Sie auf ein Hotel, damit die Werte angezeigt werden. Hier können Sie auf das Plus-Symbol klicken, um das Hotel auszuwählen.<br><br>Zeitvorgabe: Maximal 3 Minuten<br>Verbleibend: <span id='time'>3:00</span><br><br><strong>Fortschritt:</strong>",
						dataSet: evaluationDatasets.vientiane,
						maxPrice: 20,
						time: 3,
						algA: 3,
				...
				case 7:
					cluster.evaluation.findCityStep({
						html: "<h1>Evaluation: Clustering für heterogene Point-Clouds</h1>Gruppe: <strong>"+cluster.evaluation.group+"</strong><h2>Aufgabe 7</h2>Finden Sie nun erneut die 2 Hotels nahe dem \"East Potomac Park\" in Washington, USA, die den folgenden Anforderungen entsprechen:<br><br>Preis: maximal 50€<br>Sterne: mindestens 2<br><br>Klicken Sie auf ein Hotel, damit die Werte angezeigt werden. Hier können Sie auf das Plus-Symbol klicken, um das Hotel auszuwählen.<br><br>Zeitvorgabe: Maximal 3 Minuten<br>Verbleibend: <span id='time'>3:00</span><br><br><strong>Fortschritt:</strong>",
						dataSet: evaluationDatasets.washington,
						maxPrice: 50,
						time: 3,
						algA: 1,
				...
				case 8:
					cluster.evaluation.findCityStep({
						html: "<h1>Evaluation: Clustering für heterogene Point-Clouds</h1>Gruppe: <strong>"+cluster.evaluation.group+"</strong><h2>Aufgabe 8</h2>Finden Sie jetzt erneut die 2 Hotels nahe dem Park \"Atatürk Orman Çiftliği\" in Ankara, Türkei. Die Hotels müssen den folgenden Kriterien entsprechen:<br><br>Preis: maximal 50€<br>Sterne: mindestens 2<br><br>Klicken Sie auf ein Hotel, damit die Werte angezeigt werden. Hier können Sie auf das Plus-Symbol klicken, um das Hotel auszuwählen.<br><br>Zeitvorgabe: Maximal 3 Minuten<br>Verbleibend: <span id='time'>3:00</span><br><br><strong>Fortschritt:</strong>",
						dataSet: evaluationDatasets.ankara,
						maxPrice: 50,
						time: 3,
						algA: 2,
				...
				case 9:
					...
					cluster.evaluation.findCityStep({
						html: "<h1>Evaluation: Clustering für heterogene Point-Clouds</h1>Gruppe: <strong>"+cluster.evaluation.group+"</strong><h2>Aufgabe 9</h2>Finden Sie 2 Hotels nahe des Flusses \"Huangpu River\" im Zentrum (Ballungsgebiet) Shanghai, China. Die Hotels müssen die folgenden Kriterien erfüllen:<br><br>Preis: maximal 50€<br>Sterne: mindestens 1<br><br>Klicken Sie auf ein Hotel, damit die Werte angezeigt werden. Hier können Sie auf das Plus-Symbol klicken, um das Hotel auszuwählen.<br><br>Zeitvorgabe: Maximal 3 Minuten<br>Verbleibend: <span id='time'>3:00</span><br><br><strong>Fortschritt:</strong>",
						dataSet: evaluationDatasets.shanghai,
						maxPrice: 50,
						time: 3,
						algA: 3,
				...
				case 10:
					...
					cluster.evaluation.findCityStep({
						html: "<h1>Evaluation: Clustering für heterogene Point-Clouds</h1>Gruppe: <strong>"+cluster.evaluation.group+"</strong><h2>Aufgabe 10</h2>Finden Sie 2 Hotels nahe des Flusses \"River Mersey\" in Liverpool, England. Die Hotels müssen die folgenden Kriterien erfüllen:<br><br>Preis: maximal 40€<br>Sterne: mindestens 1<br><br>Klicken Sie auf ein Hotel, damit die Werte angezeigt werden. Hier können Sie auf das Plus-Symbol klicken, um das Hotel auszuwählen.<br><br>Zeitvorgabe: Maximal 3 Minuten<br>Verbleibend: <span id='time'>3:00</span><br><br><strong>Fortschritt:</strong>",
						dataSet: evaluationDatasets.liverpool,
						maxPrice: 40,
						time: 3,
						algA: 2,
		...
		step1: function(param){
			if($("#evaluationNumber").val() == ""){
				alert("Bitte geben Sie Ihr Pseudonym ein.");
				return;
			}
		...
		clickedPoint: function(param){
			try{cluster.infoWindow.close();}catch(e){}
	...
	calculations: {
		...
		getBoundsOfPolygon: function(params){ // params = {polygon: .. OR points: ...}
			...
			for (var i = 0; i < path.length; i++) {
				...
				lng = params.polygon != null ? path[i].lng() : path[i].get.pos().lng(); // TODO: b,d in lat(), lng()
